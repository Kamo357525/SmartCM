...
import { Annual } from "../../../../assets/faceData";
  ...
  return (
    <View style={style.container}>
      ...
      >
        ...
        />
        <VictoryBar
          style={{ data: { fill: "#F4C584", width: size[10] } }}
        ...
        <VictoryStack>
          <VictoryBar
            style={{ data: { fill: "#EF988F", width: size[10] } }}
            data={Annual}
            x="quarter"
            y="day"
            cornerRadius={{
              top: () => size[4], bottom: () => size[4],
            }}
          />
          <VictoryBar
            data={Annual}
            style={{ data: { fill: "#92BEFA", width: size[10] } }}
            x="quarter"
            y="Vacation"
            cornerRadius={{
              top: () => size[4], bottom: () => size[4],
          ...
          <VictoryBar
            ...
            x="quarter"
            y="Hours"
            style={{ data: { fill: "#83B7AD", width: size[10] } }}
            cornerRadius={{
              top: () => size[4], bottom: () => size[4],
            }}
          />
